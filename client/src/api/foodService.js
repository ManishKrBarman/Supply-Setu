...
export const mockFoods = [
  {
    ...
    description:
      "Crispy potato patties topped with yogurt, chutneys and spices",
    category: "Chaat",
    price: 50,
    preparationTime: 10,
    ingredients: [
    ...
    supplierInfo: [
      {
        supplierId: "61dbae02fc13ae1d39000001",
        name: "Singh Vegetable Supply",
        items: ["Potatoes", "Tomatoes", "Onions"],
      },
      {
        supplierId: "61dbae02fc13ae1d39000002",
        name: "Sharma Masala Mart",
        items: ["Pav Bhaji Masala"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    name: "Pani Puri",
    description:
      "Hollow crispy puris filled with spicy tangy water, potatoes and chickpeas",
    category: "Chaat",
    price: 40,
    preparationTime: 5,
    ingredients: [
...
export const mockTrendingFoods = [
  ...
  },
  {
    ...
    priceRange: "₹30-50",
    description:
      "Hollow crispy puris with spicy tangy water, potatoes and chickpeas",
...
export const mockStreetFoodRecipes = [
  {
    ...
    description:
      "Healthy and delicious savory pancakes made with yellow moong dal",
    ingredients: [
      "Yellow Moong Dal",
      "Green Chillies",
      "Ginger",
